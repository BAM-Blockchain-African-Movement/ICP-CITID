...
const getCurrentDateTime = () => {
  ...
  function handleSubmit(event) {
    ...
    hello_world_backend.createUser( roleName, nameName,emailName,doc ,passwordName, dateName)
      .then((result) => {
      ...
      .catch((error) => {
        ...
        // Handle errors appropriately, display an error message to the user
      });
    ...
    <div className="contact-form" id="contact">
      ...
      <div className="w-left">
        <div className="awesome">
          <span style={{ color: darkMode ? 'white' : '' }}>Lunch Board</span>
      ...
      <div className="c-right">
        <form action="#" onSubmit={handleSubmit}>
          ...
          {/* <input type="" name="role" id="role" className="user" /> */}
          <select name="role" id="role" className="user">
